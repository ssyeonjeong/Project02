...
class AddOneViewController: UIViewController,UITextFieldDelegate,UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let listArray = ["스킨","로션","크림","에센스","팩/마스크","미스트","핸드크림","선크림"]
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        textCategory.text = listArray[row]
    }
    ...
    @IBAction func firstSave(_ sender: UIBarButtonItem) {
      
        let context = getContext()
        let entity = NSEntityDescription.entity(forEntityName: "SkinCare", in: context)
